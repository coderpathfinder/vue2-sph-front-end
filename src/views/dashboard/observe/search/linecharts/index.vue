        ...
        <div class="main">
            ...
            <svg t="1637478902688" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                ...
                <path
                    ...
                    fill="#1afa29" p-id="3319"></path>
                <path d="M384.1536 444.142933h1.5872l-20.48 409.6h268.2368l-20.48-409.6" fill="#1afa29" p-id="3320"></path>
                <path
                ...
                <path
                    ...
                    fill="#1afa29" p-id="3325"></path>
            </svg>
            <svg t="1637478988225" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                p-id="4331" width="16" height="16">
                <path d="M252.484267 566.749867h11.776v16.6912h-11.776zM815.684267 566.8352h10.461866v16.9984h-10.461866z"
                    fill="#996E28" p-id="4332"></path>
                <path
                ...
                <path
                    ...
                    fill="#E8D4AB" p-id="4335"></path>
                <path d="M654.523733 591.854933h-1.5872l20.48-409.6H405.1968l20.48 409.6" fill="#AF3131" p-id="4336"></path>
                <path d="M654.523733 593.5616h-1.5872l20.48-409.6H405.1968l20.48 409.6" fill="#D5382E" p-id="4337"></path>
                <path
