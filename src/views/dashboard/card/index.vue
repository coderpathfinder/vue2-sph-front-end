                ...
                <el-card>
                    <Detail title="总销售额" count="¥ 126560">
                        <template slot="charts">
                            <span>周同比&nbsp;&nbsp;56.67%
                                <svg t="1689953025491" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                    xmlns="http://www.w3.org/2000/svg" p-id="2444" width="16" height="16">
                                    <path
                                        ...
                                        p-id="2445" fill="#d81e06"></path>
                                </svg>
                            </span>
                            &nbsp;&nbsp;
                            <span>日同比&nbsp;&nbsp;19.96% &nbsp;
                                <svg t="1689953244450" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                    xmlns="http://www.w3.org/2000/svg" p-id="3464" width="16" height="16">
                                    <path
